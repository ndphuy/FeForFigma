  ...
  const screensList = [
    {
      ...
      screens: [
        ...
        { name: '2. Kết quả tìm kiếm (Search Results)', path: '/passenger/results' },
        { name: '3. Chọn điểm đón thuận tiện (Pickup Picker)', path: '/passenger/pickup-picker' },
        { name: '4. Chi tiết chuyến đi (Trip Detail)', path: '/passenger/trip-detail/trip_001' },
        { name: '5. Bóc tách chi phí (Cost Breakdown)', path: '/shared/cost-breakdown' },
        { name: '6. Gửi yêu cầu đặt chỗ (Request Booking)', path: '/passenger/request-booking/trip_001' },
        { name: '7. Đang chờ tài xế duyệt (Booking Pending)', path: '/passenger/booking-pending/trip_001' },
    ...
    },
    {
      ...
      screens: [
        ...
        { name: '2. Tạo chuyến đi 6 bước (Create Trip)', path: '/driver/create-trip' },
